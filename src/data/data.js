  ...
  cards: [
    {
      ...
      title: "Starter Plan",
      services: [
        { name: "Store unlimited data", textDecoration: null, Icon: HiCheck },
        { name: "Export to pdf, xls, csv", textDecoration: "line-through", Icon: HiOutlineX },
        { name: "Cloud server support", textDecoration: "line-through", Icon: HiOutlineX },
      ],
      price: "$9.99",
    ...
    },
    {
      ...
      services: [
        { name: "Store unlimited data", textDecoration: null, Icon: HiCheck },
        { name: "Export to pdf, xls, csv", textDecoration: null, Icon: HiCheck },
        { name: "Cloud server support", textDecoration: "line-through", Icon: HiOutlineX },
      ],
      price: "$19.99",
      userAmount: "up to 3 user + 1.99 per user",
    ...
    },
    {
      ...
      services: [
        { name: "Store unlimited data", textDecoration: null, Icon: HiCheck },
        { name: "Export to pdf, xls, csv", textDecoration: null, Icon: HiCheck },
        { name: "Cloud server support", textDecoration: null, Icon: HiCheck },
      ],
      price: "$29.99",
      userAmount: "up to 3 user + 1.99 per user",
      delay: 900,
...
export const copyright = {
  ...
  copyText: "© 2022 XPence. All Right Reserved.",
  social: [
